...
#
#
write.csv(indicatorsHH, "data-raw/indicatorsHH.cscv", row.names = FALSE)
#
#
#
devtools::use_data(indicatorsHH, overwrite = TRUE)
...
################################################################################
#
#  Grouped age variable 'ageBand' (used when calculating age-specific scores)
#
...
devtools::use_data(indicatorsCH1, overwrite = TRUE)

write.csv(indicatorsCH2, "data-raw/indicatorsCH2.csv", row.names = FALSE)
devtools::use_data(indicatorsCH2, overwrite = TRUE)
