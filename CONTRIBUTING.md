...
- Submit an issue on the [issues
  page](https://github.com/rapidsurveys/bbw/issues)

## Code contributions

- Fork this repository to your Github account

- Clone your forked version to your machine with

``` bash
git clone https://github.com/<yourgithubusername>/bbw.git
```

- Make sure to track progress upstream i.e., on our version of `bbw` at
  `rapidsurveys/bbw`, by doing
